<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="address.aspx.cs" Inherits="_3200_project.address" %>
    ...
    <asp:Button ID="Button6" runat="server" ForeColor="#339966" Height="35px" OnClick="Button6_Click" Text="লগ ইন" Width="116px" Font-Bold="True" Font-Size="Medium" />
        ...
        <br />
                            ...
                            <div class="content-container">
                                <div class="center">
    <h1  style="text-align:center;"><b><font style="color:#112C39 ;">যোগাযোগ করুন নিম্নে বর্ণিত ঠিকানা সমূহেঃ</font></b> </h1>
                                    
</div>
                              <br />
								
                                    <p><font style="color:#f05a28;"><b>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbspহেড অফিসঃ</font></b></p>
                                   
                                       
                                    
                                           
                                        <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp Bangabandhu Sheikh Mujibor Rahman Hall</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp Khulna University of Engineering  & Technology</p>
										<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp Khulna, Bangladesh</p>
                                    ...
                                    <br />
                                         ...
                                         <div class="sub-header" > <font style="color:#f05a28;">&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp কাস্টমার কেয়ার সার্ভিসঃ </font></div>  
                                         <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp সপ্তাহে ৭ দিন ২৪ ঘণ্টা</p>    
							             	<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp ই -মেইলঃ </p>
												<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp info@eshop.com</p>
							 
									   
									   
                                       <br><p><font style="color:#f05a28;"><b>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp কাস্টমার সাপোর্ট এর জন্য যোগাযোগ করুনঃ</b></font></p>
                                         <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp customer@eshop.com</p> 
                                           <p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp ফোনে অর্ডার, ডেলিভারী সংক্রান্ত তথ্য/আপনার পন্যের ডেলিভারী আপডেট জানতে যোগাযোগ করুনঃ</p> 										 
                          	<p>&nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp 01867625757</p>
           <br />
<hr />
