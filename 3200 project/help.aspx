<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="help.aspx.cs" Inherits="_3200_project.help" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" ForeColor="#339966" Height="36px" OnClick="Button2_Click" Text="পণ্য সংযুক্তি" Width="106px" Font-Bold="True" Font-Size="Medium" />
    ...
    <asp:Button ID="Button6" runat="server" ForeColor="#339966" Height="35px" OnClick="Button6_Click" Text="লগ ইন" Width="116px" Font-Bold="True" Font-Size="Medium" />
        ...
        <asp:HyperLink ID="HyperLink7" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#FF9933" NavigateUrl="~/sellingrule.aspx">পণ্য বিক্রির প্রক্রিয়া</asp:HyperLink>
        <br />
        <br />
    
                            

        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="Red" NavigateUrl="~/replacement.aspx">পণ্য পরিবর্তন প্রক্রিয়া</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#000066" NavigateUrl="~/refund.aspx">রিফান্ড পলিসি</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#003300" NavigateUrl="~/howtobuy.aspx">অর্ডার দেয়ার নিয়ম</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink4" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#660066" NavigateUrl="~/address.aspx">আমাদের ঠিকানা</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink5" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#663300" NavigateUrl="https://www.google.com/maps/place/Khulna+University+Of+Engineering+%26+Technology/@22.9005573,89.5001678,17z/data=!3m1!4b1!4m5!3m4!1s0x39ff9bda1d0ff6e5:0x123a926908efcd0c!8m2!3d22.9005524!4d89.5023565?fbclid=IwAR3RNF32G7BPIFyM2Or-u2okYEwQxtmRNhNbF7_f1ceCnk1OQlKl4piJl1s">সাইট ম্যাপ</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink6" runat="server" Font-Bold="True" Font-Size="X-Large" Font-Underline="True" ForeColor="#993333" NavigateUrl="https://www.facebook.com/Eshopcom-109211907241416">আমাদের ফেসবুক পেজ</asp:HyperLink>
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
